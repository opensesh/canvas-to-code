...
Part of the {{feature}} redesign via [canvas-to-code](https://github.com/opensesh/canvas-to-code). Plan: `.canvas-to-code/state/{{feature}}/plan.md` · Spike: `docs/spikes/design-system/{{YYYY-MM}}/{{YYYY-MM-DD}}-{{feature}}-bridge.md`.
